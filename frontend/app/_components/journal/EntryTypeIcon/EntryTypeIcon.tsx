...
const ICON_SHAPES: Record<EntryType, ReactElement[]> = {
  meal: [stroke("M2.5 9h15", "bowl"), stroke("M4.5 9a5.5 5 0 0 0 11 0", "food"), stroke("M10 3.5v2", "steam")],
  ...
  medication: [
    <rect key="pill" x={3.5} y={7.5} width={13} height={5} rx={2.5} fill="none" stroke="currentColor" strokeWidth={1.6} />,
    stroke("M10 7.5v5", "split"),
  ],
  weight: [stroke("M4 15a6 6 0 0 1 12 0", "arc"), stroke("M4 15h12", "base"), stroke("M10 15l2.6-3.6", "needle")],
  vet_visit: [
  ...
  free_note: [
    <rect key="page" x={4} y={3.5} width={12} height={13} rx={2.2} fill="none" stroke="currentColor" strokeWidth={1.6} />,
...
export function SearchIcon({ size = 18 }: { size?: number }) {
  return (
    ...
    >
      ...
      <path d="M12.8 12.8L17 17" fill="none" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" />
    </svg>
  );
}
