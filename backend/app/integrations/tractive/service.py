...
def _rollup_to_row(
    ...
    return {
        ...
        "heart_rate_record_count": rollup.resting_heart_rate_records.record_count,
        "heart_rate_record_mean": rollup.resting_heart_rate_records.mean,
        "heart_rate_ci95_half_width": rollup.resting_heart_rate_records.ci95_half_width,
        "respiratory_rate_record_count": rollup.resting_respiratory_rate_records.record_count,
        "respiratory_rate_record_mean": rollup.resting_respiratory_rate_records.mean,
        "respiratory_rate_ci95_half_width": (
            rollup.resting_respiratory_rate_records.ci95_half_width
        ),
        "respiratory_rate_night_record_count": rollup.respiratory_night_day.night_record_count,
        "respiratory_rate_night_record_mean": rollup.respiratory_night_day.night_mean,
        "respiratory_rate_day_record_count": rollup.respiratory_night_day.day_record_count,
        "respiratory_rate_day_record_mean": rollup.respiratory_night_day.day_mean,
        "sleep_longest_bout_minutes": rollup.sleep_architecture.longest_bout_minutes,
        "sleep_bout_count": rollup.sleep_architecture.bout_count,
        "sleep_fragmentation_index": rollup.sleep_architecture.fragmentation_index,
        "outings_count": rollup.outings.count,
        "outings_total_minutes": rollup.outings.total_minutes,
        "outings": [entry.model_dump(mode="json") for entry in rollup.outings.entries],
        "home_latitude": rollup.home_latitude,
        "home_longitude": rollup.home_longitude,
